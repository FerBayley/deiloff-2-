			...
			<section class="Central">
				...
				<section class="Materiales">
					<section class="Contenedor-materiales">
						<h2>Materiales > <span>Porfido</span></h2>
				...
				<!-- GALERIA 1 -->
					<div class="Gal1">	
						<?php query_posts("category_name=porfido-col1"); ?>
				...
				<!-- GALERIA 2 -->
				<div class="Gal2">
					<?php query_posts("category_name=porfido-col2"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
				...
				<!-- GALERIA 3 -->
				<div class="Gal3">
					<?php query_posts("category_name=porfido-col3"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
				...
				<!-- GALERIA 4 -->
				<div class="Gal4">
					<?php query_posts("category_name=porfido-col4"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
				...
				<!-- GALERIA 5 -->
				<div class="Gal5">
					<?php query_posts("category_name=porfido-col5"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
