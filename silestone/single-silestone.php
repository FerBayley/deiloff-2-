	...
	<section class="Main">
		<section class="Preheader"></section> <!-- End of Preheader -->
			...
			<section class="Central">
				...
				<!-- GALERIA 1 -->
					<div class="Gal1">	
						<?php query_posts("category_name=silestone-col1"); ?>
				...
				<!-- GALERIA 2 -->
				<div class="Gal2">
					<?php query_posts("category_name=silestone-col2"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
				...
				<!-- GALERIA 3 -->
				<div class="Gal3">
					<?php query_posts("category_name=silestone-col3"); ?>
				...
				<!-- GALERIA 4 -->
				<div class="Gal4">
					<?php query_posts("category_name=silestone-col4"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
				...
				<!-- GALERIA 5 -->
				<div class="Gal5">
					<?php query_posts("category_name=silestone-col5"); ?>
					<?php if (have_posts() ) : while (have_posts() ) : the_post(); ?>
